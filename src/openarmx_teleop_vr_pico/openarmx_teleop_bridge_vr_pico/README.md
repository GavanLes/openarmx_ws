# openarmx_teleop_bridge_vr_pico

## 1. What This Package Does

`openarmx_teleop_bridge_vr_pico` is a ROS 2 bridge package.  
...
├── package.xml
└── src/
    └── openarmx_teleop_bridge_vr_pico_node.cpp
```
...
-> `openarmx_teleop_bridge_vr_pico_node`  
